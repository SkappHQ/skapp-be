package com.rootcode.skapp.leaveplanner.repository.impl;

import com.fasterxml.jackson.databind.node.ObjectNode;
import com.rootcode.skapp.common.model.Auditable_;
import com.rootcode.skapp.common.model.OrganizationConfig;
import com.rootcode.skapp.common.model.OrganizationConfig_;
...
import com.rootcode.skapp.leaveplanner.model.CarryForwardInfo_;
import com.rootcode.skapp.leaveplanner.model.LeaveEntitlement;
import com.rootcode.skapp.leaveplanner.model.LeaveEntitlement_;
import com.rootcode.skapp.leaveplanner.model.LeaveType;
import com.rootcode.skapp.leaveplanner.model.LeaveType_;
import com.rootcode.skapp.leaveplanner.payload.EmployeeDateDto;
import com.rootcode.skapp.leaveplanner.payload.LeaveCycleDatesDto;
...
import com.rootcode.skapp.leaveplanner.repository.LeaveEntitlementRepository;
...
import static com.rootcode.skapp.leaveplanner.model.LeaveType_.TYPE_ID;
...
public class LeaveEntitlementRepositoryImpl implements LeaveEntitlementRepository {
	...
	@Override
	public Page<LeaveEntitlement> findAllCustomEntitlements(String search, Pageable page, int year, Long[] leaveTypeIds) {
		CriteriaBuilder criteriaBuilder = entityManager.getCriteriaBuilder();
		...
		if (leaveTypeIds != null && leaveTypeIds.length > 0) {
			CriteriaBuilder.In<Object> inClause = criteriaBuilder.in(root.get(LeaveEntitlement_.LEAVE_TYPE).get(TYPE_ID));
			for (Object leaveTypeId : leaveTypeIds) {
